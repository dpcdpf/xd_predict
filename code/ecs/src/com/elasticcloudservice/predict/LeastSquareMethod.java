...
public class LeastSquareMethod {  
     ...
     */  
    public LeastSquareMethod(Integer[] x, Integer[] y, int n) {  
     ...
     *            The order of polynomial 
     */  
    public LeastSquareMethod(Integer[] x, Integer[] y, double[] weight, int n) {  
    ...
    public static void main(String[] args) {  
        LeastSquareMethod eastSquareMethod = null;  
        ...
        LeastSquareMethod eastSquareMethod2 =null;  
